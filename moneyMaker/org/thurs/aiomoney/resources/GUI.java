...
import org.thurs.aiomoney.nodes.cowhides.Fixer;
...
import org.thurs.aiomoney.nodes.grabbones.WalkToBox1;
...
import org.thurs.aiomoney.nodes.killunicorns.PickupHorns;
...
import org.thurs.aiomoney.nodes.cowhidekill.*;
...
public class GUI extends JFrame {
	...
	private void initComponents() {
		...
		comboBox1.setModel(new DefaultComboBoxModel<>(new String[] {
				"Cow Hides", "Kill Cows & Loot", "Swamp Tar", "Flax Picking", "Spin Flax",
		...
		button1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (chosen.equals("Swamp Tar")) {
					...
					AIOMoneyMaker.NODES.add(new WalkToBox1());
					...
					AIOMoneyMaker.NODES.add(new Fixer());
					...
					AIOMoneyMaker.NODES.add(new PickupHorns());
				...
				} else if (chosen.equals("Kill Cows & Loot")) {
					Variables.method = "Killing Cows";
					AIOMoneyMaker.NODES.add(new BankCowhides());
					AIOMoneyMaker.NODES.add(new BankToCows());
					AIOMoneyMaker.NODES.add(new CowsToBank());
					AIOMoneyMaker.NODES.add(new KillCows());
					AIOMoneyMaker.NODES.add(new WalkToCowsOnDeath());
					AIOMoneyMaker.NODES.add(new pickupShit());
