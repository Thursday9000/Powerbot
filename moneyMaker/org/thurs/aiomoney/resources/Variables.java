...
public class Variables {
	...
	public  Area BONE_COW_AREA = new Area(new Tile[] {
			new Tile(3268, 3252, 0), new Tile(3243, 3252, 0),
			new Tile(3239, 3298, 0), new Tile(3268, 3297, 0) });

	 final Area LUMBY_AREA = new Area(new Tile[] {
	...
	public  Area COW_AREA = new Area(new Tile[] {
	...
	public  Area COW_HIDE_ANTI_BAN = new Area(new Tile[] {
	 ...
	 final Area DEPOSITBOX_AREA = new Area(new Tile[] {
	...
	// Paths
	public  final Tile[] FLAX_TO_BANK = new Tile[] {
	...
	public  final Tile[] BANK_TO_FLAX = new Tile[] {
	...
	public  final Tile[] BANK_TO_SPINNER = new Tile[] {
	...
	public  final Tile[] SPINNER_TO_BANK = new Tile[] {
	...
	public  final Tile[] GLITCH_TO_BANK = new Tile[] {
	...
	public  final Tile[] BOX_TO_BONES = new Tile[] {
	...
	public  final Tile[] BONES_TO_BOX = new Tile[] {
	...
	public  final Tile[] ANTI_BAN_WALK = new Tile[] {
	...
	public  final Tile[] BONE_COW_FIX = new Tile[] {
	...
	public  final Tile[] FEATHER_TO_BANK = new Tile[] {
