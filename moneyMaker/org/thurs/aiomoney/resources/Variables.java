...
public class Variables {
	...
	public static final int COW_ID[] = {12363, 12362};
	...
	public static final Area LUMBY_AREA = new Area(new Tile[] {
	...
	public static final Area COW_AREA = new Area(new Tile[] {
	...
	public static final Area DEPOSITBOX_AREA = new Area(new Tile[] {
	...
	public static final Area UNICORN_AREA = new Area(new Tile[] {
			new Tile(3298, 3382, 0), new Tile(3292, 3383, 0),
			new Tile(3287, 3383, 0), new Tile(3282, 3383, 0),
			new Tile(3277, 3382, 0), new Tile(3272, 3382, 0),
			new Tile(3267, 3381, 0), new Tile(3262, 3380, 0),
			new Tile(3257, 3379, 0), new Tile(3252, 3378, 0),
			new Tile(3247, 3378, 0), new Tile(3242, 3376, 0),
			new Tile(3241, 3371, 0), new Tile(3241, 3366, 0),
			new Tile(3243, 3361, 0), new Tile(3245, 3356, 0),
			new Tile(3248, 3352, 0), new Tile(3250, 3347, 0),
			new Tile(3252, 3342, 0), new Tile(3254, 3337, 0),
			new Tile(3257, 3333, 0), new Tile(3259, 3328, 0),
			new Tile(3264, 3326, 0), new Tile(3269, 3326, 0),
			new Tile(3274, 3326, 0), new Tile(3278, 3329, 0),
			new Tile(3283, 3329, 0), new Tile(3288, 3329, 0),
			new Tile(3293, 3329, 0), new Tile(3298, 3328, 0),
			new Tile(3303, 3328, 0), new Tile(3308, 3329, 0),
			new Tile(3313, 3332, 0), new Tile(3315, 3337, 0),
			new Tile(3313, 3342, 0), new Tile(3311, 3347, 0),
			new Tile(3309, 3352, 0), new Tile(3308, 3357, 0),
			new Tile(3307, 3362, 0), new Tile(3307, 3367, 0),
			new Tile(3307, 3372, 0), new Tile(3306, 3377, 0),
			new Tile(3306, 3382, 0), new Tile(3311, 3381, 0) });
	...
	public static final Tile[] BONES_TO_BOX = new Tile[] {
			new Tile(3247, 3237, 0), new Tile(3251, 3240, 0),
			new Tile(3254, 3245, 0), new Tile(3253, 3250, 0),
			new Tile(3250, 3254, 0), new Tile(3248, 3259, 0),
			new Tile(3243, 3261, 0), new Tile(3238, 3262, 0),
			new Tile(3233, 3262, 0), new Tile(3228, 3262, 0),
			new Tile(3223, 3262, 0), new Tile(3218, 3260, 0),
			new Tile(3213, 3261, 0) };
	...
	public static final Tile[] COW_WALKBACK = new Tile[] {
			new Tile(3221, 3218, 0), new Tile(3226, 3218, 0),
			new Tile(3231, 3218, 0), new Tile(3236, 3218, 0),
			new Tile(3236, 3223, 0), new Tile(3240, 3226, 0),
			new Tile(3245, 3226, 0), new Tile(3250, 3227, 0),
			new Tile(3255, 3227, 0), new Tile(3259, 3230, 0),
			new Tile(3260, 3235, 0), new Tile(3258, 3240, 0),
			new Tile(3257, 3245, 0), new Tile(3254, 3249, 0),
			new Tile(3250, 3252, 0), new Tile(3248, 3257, 0),
			new Tile(3247, 3262, 0), new Tile(3250, 3266, 0),
			new Tile(3255, 3268, 0) };

	public static final Area ftile = new Area(new Tile[] {
			new Tile(3159, 3491, 0), new Tile(3159, 39492, 0) });

	public static final Area BONE_BANK_AREA = new Area(new Tile[] {
			new Tile(3214, 3264, 0), new Tile(3209, 3263, 0),
			new Tile(3207, 3258, 0), new Tile(3210, 3254, 0),
			new Tile(3215, 3254, 0), new Tile(3218, 3258, 0) });
