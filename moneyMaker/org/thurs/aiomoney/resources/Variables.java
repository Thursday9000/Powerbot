...
public class Variables {
	...
	public static final Area LUMBY_AREA = new Area(new Tile[] { new Tile(3209, 3219, 0),
			...
			new Tile(3230, 3227, 0), new Tile(3233, 3222, 0),
			new Tile(3233, 3217, 0), new Tile(3230, 3213, 0),
			new Tile(3228, 3208, 0), new Tile(3223, 3206, 0),
			new Tile(3218, 3204, 0), new Tile(3213, 3203, 0),
			new Tile(3208, 3202, 0), new Tile(3203, 3202, 0),
			new Tile(3200, 3206, 0), new Tile(3198, 3211, 0),
			new Tile(3198, 3216, 0), new Tile(3198, 3221, 0),
	...
	public static final Area COW_AREA = new Area(new Tile[] { new Tile(3267, 3255, 0),
			...
			new Tile(3268, 3290, 0), new Tile(3268, 3295, 0),
			new Tile(3264, 3298, 0), new Tile(3259, 3299, 0),
			new Tile(3254, 3300, 0), new Tile(3249, 3300, 0),
			new Tile(3244, 3299, 0), new Tile(3239, 3297, 0),
			new Tile(3237, 3292, 0), new Tile(3238, 3287, 0),
			new Tile(3239, 3282, 0), new Tile(3242, 3278, 0),
			new Tile(3246, 3275, 0), new Tile(3246, 3270, 0),
			new Tile(3247, 3265, 0), new Tile(3249, 3260, 0),
	...
	public static final Tile[] FLAX_TO_BANK = new Tile[] { new Tile(2741, 3443, 0),
			...
			new Tile(2729, 3469, 0), new Tile(2728, 3474, 0),
	...
	public static final Tile[] BOX_TO_BONES = new Tile[] { new Tile(3214, 3259, 0),
			...
			new Tile(3247, 3258, 0), new Tile(3251, 3255, 0),
	...
	public static final Tile[] FEATHER_TO_BANK = new Tile[] { new Tile(3232, 3293, 0),
			...
			new Tile(3248, 3270, 0), new Tile(3249, 3267, 0),
			new Tile(3249, 3262, 0), new Tile(3244, 3261, 0),
			new Tile(3239, 3262, 0), new Tile(3234, 3262, 0),
			new Tile(3229, 3262, 0), new Tile(3224, 3261, 0),
