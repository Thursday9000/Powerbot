...
public class ClimbLadder extends Node {
	...
	public boolean activate() {
		return SceneEntities.getLoaded(25938) != null
				...
				&& var.SPINNER_AREA.contains(Players.getLocal());
	}

	@Override
	public void execute() {

		SceneEntities.getNearest(var.LADDER_ID).interact("Climb-up", "Ladder");
		Timer t = new Timer(2350);
		while (t.isRunning() && SceneEntities.getNearest(var.LADDER_ID) == null) {
			Task.sleep(20);
		}
